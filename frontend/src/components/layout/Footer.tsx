      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <Link to="/" className="text-2xl font-serif font-bold text-white hover:text-blue-400 transition-colors">
              Alumni Portal
            </Link>
          ...
          {/* Member Area */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">Member Area</h3>
            <ul className="space-y-2">
...
const SocialLink: React.FC<SocialLinkProps> = ({ href, icon }) => {
  const getIconLabel = (iconType: string) => {
    ...
    return labels[iconType as keyof typeof labels];
  };
  ...
  return (
    <a 
      ...
      className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-blue-400 hover:bg-blue-600 hover:text-white transition-all duration-200 hover:scale-105"
